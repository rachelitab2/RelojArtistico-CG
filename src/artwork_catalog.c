...
static const ArtworkInfo ARTWORK_CATALOG[] =
{
    ...
    {
        ART_HOKUSAI,                                           /* [PLACEHOLDER] */
        "La gran ola de Kanagawa",
        "Katsushika Hokusai",
        "1831",
        "Ukiyo-e",
        "Ola monumental capturada en azul prussiano; el Monte Fuji al fondo.",
    ...
    {
        ART_ROTHKO,                                            /* [PLACEHOLDER] */
        "No. 61 (Oxido y azul)",
        "Mark Rothko",
        "1953",
        "Expresionismo abstracto",
        "Campos de color que flotan y respiran, generando una presencia casi fisica.",
